...
INSERT INTO villains (name, classType, level, experience, attackDmg, armorDefense, helmHP)
VALUES	('Vicious Goblin', 'Goblins', 1, 0, 5, 1, 9),
		('Filthy Orc', 'Orcs', 1, 0, 12, 5, 12),
		('Rotten Troll', 'Trolls', 1, 0, 20, 2, 20);
...
VALUES	('Amulet of the Stone Heart', 'Helm', 13,
		"A heavy, obsidian pendant that increases the wearer's overall resilience, allowing them to endure more damage."),

		('Cinderblade Fragment', 1, 'Weapon', 9,
		'A jagged piece of metal pulsing with heat. Purely focused on increasing offensive output.'),

		("Warden's Gauntlets", 'Armor', 9,
